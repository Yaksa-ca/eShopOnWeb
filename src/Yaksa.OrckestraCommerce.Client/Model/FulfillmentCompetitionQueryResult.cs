...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FulfillmentCompetitionQueryResult")]
    public partial class FulfillmentCompetitionQueryResult : IEquatable<FulfillmentCompetitionQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillmentCompetitionQueryResult" /> class.
        /// </summary>
        ...
        public FulfillmentCompetitionQueryResult(List<FulfillmentCompetition> results = default(List<FulfillmentCompetition>), int totalCount = default(int))
        {
        ...
        public List<FulfillmentCompetition> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FulfillmentCompetitionQueryResult {\n");
        ...
        {
            return this.Equals(input as FulfillmentCompetitionQueryResult);
        }

        /// <summary>
        /// Returns true if FulfillmentCompetitionQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FulfillmentCompetitionQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FulfillmentCompetitionQueryResult input)
        {
            if (input == null)
                return false;
