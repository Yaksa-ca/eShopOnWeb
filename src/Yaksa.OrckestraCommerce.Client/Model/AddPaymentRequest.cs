...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddPaymentRequest")]
    public partial class AddPaymentRequest : IEquatable<AddPaymentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddPaymentRequest" /> class.
        /// </summary>
        ...
        /// <param name="amount">The amount of the Payment to create..</param>
        /// <param name="billingAddress">billingAddress.</param>
        /// <param name="id">The unique identifier of the Payment to create..</param>
        /// <param name="propertyBag">propertyBag.</param>
        public AddPaymentRequest(string cultureName = default(string), string workflowToExecute = default(string), double amount = default(double), Address billingAddress = default(Address), string id = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>))
        {
        ...
        /// </summary>
        /// <value>The amount of the Payment to create.</value>
        ...
        /// </summary>
        /// <value>The unique identifier of the Payment to create.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddPaymentRequest {\n");
        ...
        {
            return this.Equals(input as AddPaymentRequest);
        }

        /// <summary>
        /// Returns true if AddPaymentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddPaymentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddPaymentRequest input)
        {
            if (input == null)
                return false;
