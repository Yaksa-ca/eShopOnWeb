...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    public partial class Address : IEquatable<Address>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="addressName">Name of the address. A customer/store/warehouse cannot have two addresses with the same name..</param>
        ...
        /// <param name="isPreferredBilling">a boolean which specifies if this address should be used as a billing address in the case of multiple addresses..</param>
        /// <param name="isPreferredShipping">a boolean which specifies if this address should be used as a shipping address in the case of multiple addresses..</param>
        /// <param name="lastModified">the date that the last modification was applied to the address..</param>
        /// <param name="lastModifiedBy">the identifier of the operator who last modified the address..</param>
        ...
        public Address(string addressName = default(string), string city = default(string), string countryCode = default(string), string email = default(string), string firstName = default(string), string id = default(string), bool isPreferredBilling = default(bool), bool isPreferredShipping = default(bool), DateTime lastModified = default(DateTime), string lastModifiedBy = default(string), string lastName = default(string), double latitude = default(double), string line1 = default(string), string line2 = default(string), double longitude = default(double), string notes = default(string), string phoneExtension = default(string), string phoneNumber = default(string), string postalCode = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), string regionCode = default(string))
        {
        ...
        /// </summary>
        /// <value>Name of the address. A customer/store/warehouse cannot have two addresses with the same name.</value>
        ...
        /// </summary>
        /// <value>a boolean which specifies if this address should be used as a billing address in the case of multiple addresses.</value>
        ...
        /// </summary>
        /// <value>a boolean which specifies if this address should be used as a shipping address in the case of multiple addresses.</value>
        ...
        /// </summary>
        /// <value>the date that the last modification was applied to the address.</value>
        ...
        /// </summary>
        /// <value>the identifier of the operator who last modified the address.</value>
