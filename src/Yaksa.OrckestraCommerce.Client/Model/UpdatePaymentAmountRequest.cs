...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdatePaymentAmountRequest")]
    public partial class UpdatePaymentAmountRequest : IEquatable<UpdatePaymentAmountRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePaymentAmountRequest" /> class.
        /// </summary>
        ...
        public UpdatePaymentAmountRequest(string cultureName = default(string), string workflowToExecute = default(string), double amount = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePaymentAmountRequest {\n");
        ...
        {
            return this.Equals(input as UpdatePaymentAmountRequest);
        }

        /// <summary>
        /// Returns true if UpdatePaymentAmountRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePaymentAmountRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePaymentAmountRequest input)
        {
            if (input == null)
                return false;
