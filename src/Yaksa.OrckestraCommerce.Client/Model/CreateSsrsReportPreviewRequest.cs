...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// Reporting API.
    /// </summary>
    [DataContract(Name = "CreateSsrsReportPreviewRequest")]
    public partial class CreateSsrsReportPreviewRequest : IEquatable<CreateSsrsReportPreviewRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSsrsReportPreviewRequest" /> class.
        /// </summary>
        ...
        public CreateSsrsReportPreviewRequest(string cultureName = default(string), List<ReportParameterValue> reportParameters = default(List<ReportParameterValue>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSsrsReportPreviewRequest {\n");
        ...
        {
            return this.Equals(input as CreateSsrsReportPreviewRequest);
        }

        /// <summary>
        /// Returns true if CreateSsrsReportPreviewRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSsrsReportPreviewRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSsrsReportPreviewRequest input)
        {
            if (input == null)
                return false;
