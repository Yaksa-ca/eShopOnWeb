...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetFulfillmentLocationTimeSlotByIdRequest")]
    public partial class GetFulfillmentLocationTimeSlotByIdRequest : IEquatable<GetFulfillmentLocationTimeSlotByIdRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFulfillmentLocationTimeSlotByIdRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetFulfillmentLocationTimeSlotByIdRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFulfillmentLocationTimeSlotByIdRequest" /> class.
        /// </summary>
        ...
        public GetFulfillmentLocationTimeSlotByIdRequest(string scopeId = default(string), string fulfillmentLocationId = default(string), FulfillmentMethodTypeEnum fulfillmentMethodType = default(FulfillmentMethodTypeEnum), string slotId = default(string))
        {
            // to ensure "fulfillmentLocationId" is required (not null)
            this.FulfillmentLocationId = fulfillmentLocationId ?? throw new ArgumentNullException("fulfillmentLocationId is a required property for GetFulfillmentLocationTimeSlotByIdRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetFulfillmentLocationTimeSlotByIdRequest {\n");
        ...
        {
            return this.Equals(input as GetFulfillmentLocationTimeSlotByIdRequest);
        }

        /// <summary>
        /// Returns true if GetFulfillmentLocationTimeSlotByIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFulfillmentLocationTimeSlotByIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFulfillmentLocationTimeSlotByIdRequest input)
        {
            if (input == null)
                return false;
