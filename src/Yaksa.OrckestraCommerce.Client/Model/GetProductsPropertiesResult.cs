...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetProductsPropertiesResult")]
    public partial class GetProductsPropertiesResult : IEquatable<GetProductsPropertiesResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductsPropertiesResult" /> class.
        /// </summary>
        ...
        public GetProductsPropertiesResult(List<ProductProperties> results = default(List<ProductProperties>), int totalCount = default(int))
        {
        ...
        public List<ProductProperties> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetProductsPropertiesResult {\n");
        ...
        {
            return this.Equals(input as GetProductsPropertiesResult);
        }

        /// <summary>
        /// Returns true if GetProductsPropertiesResult instances are equal
        /// </summary>
        /// <param name="input">Instance of GetProductsPropertiesResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetProductsPropertiesResult input)
        {
            if (input == null)
                return false;
