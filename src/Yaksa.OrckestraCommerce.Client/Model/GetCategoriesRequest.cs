...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    public partial class GetCategoriesRequest : IEquatable<GetCategoriesRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public GetCategoriesRequest(string cultureName = default(string), string scopeId = default(string))
        {
            // to ensure "scopeId" is required (not null)
            this.ScopeId = scopeId ?? throw new ArgumentNullException("scopeId is a required property for GetCategoriesRequest and cannot be null");
        ...
        {
            return this.Equals(input as GetCategoriesRequest);
        }

        /// <summary>
        /// Returns true if GetCategoriesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCategoriesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCategoriesRequest input)
        {
            if (input == null)
                return false;
