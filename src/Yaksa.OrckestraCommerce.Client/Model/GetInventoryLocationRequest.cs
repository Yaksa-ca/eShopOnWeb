...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetInventoryLocationRequest")]
    public partial class GetInventoryLocationRequest : IEquatable<GetInventoryLocationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInventoryLocationRequest" /> class.
        /// </summary>
        /// <param name="scopeId">The id of the requested scope.</param>
        /// <param name="associatedLocationId">the business id for the inventory location to retrieve.</param>
        public GetInventoryLocationRequest(string scopeId = default(string), string associatedLocationId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetInventoryLocationRequest {\n");
        ...
        {
            return this.Equals(input as GetInventoryLocationRequest);
        }

        /// <summary>
        /// Returns true if GetInventoryLocationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetInventoryLocationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetInventoryLocationRequest input)
        {
            if (input == null)
                return false;
