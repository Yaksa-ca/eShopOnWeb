...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// DeleteSegmentResult
    /// </summary>
    [DataContract(Name = "DeleteSegmentResult")]
    public partial class DeleteSegmentResult : IEquatable<DeleteSegmentResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSegmentResult" /> class.
        /// </summary>
        ...
        public DeleteSegmentResult(bool success = default(bool), List<string> validationResultCodes = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteSegmentResult {\n");
        ...
        {
            return this.Equals(input as DeleteSegmentResult);
        }

        /// <summary>
        /// Returns true if DeleteSegmentResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteSegmentResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteSegmentResult input)
        {
            if (input == null)
                return false;
