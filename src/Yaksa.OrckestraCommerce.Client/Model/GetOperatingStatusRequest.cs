...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetOperatingStatusRequest")]
    public partial class GetOperatingStatusRequest : IEquatable<GetOperatingStatusRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOperatingStatusRequest" /> class.
        /// </summary>
        ...
        public GetOperatingStatusRequest(string scopeId = default(string), string fulfillmentLocationId = default(string))
        {
        ...
        /// </summary>
        /// <value>The unique identifier of the FulfillmentLocation (Store or other) to retrieve.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetOperatingStatusRequest {\n");
        ...
        {
            return this.Equals(input as GetOperatingStatusRequest);
        }

        /// <summary>
        /// Returns true if GetOperatingStatusRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetOperatingStatusRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetOperatingStatusRequest input)
        {
            if (input == null)
                return false;
