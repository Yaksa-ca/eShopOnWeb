...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddOrUpdateCustomerAddressRequest")]
    public partial class AddOrUpdateCustomerAddressRequest : IEquatable<AddOrUpdateCustomerAddressRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddOrUpdateCustomerAddressRequest" /> class.
        /// </summary>
        ...
        public AddOrUpdateCustomerAddressRequest(string addressName = default(string), string city = default(string), string countryCode = default(string), string email = default(string), string firstName = default(string), bool isPreferredBilling = default(bool), bool isPreferredShipping = default(bool), string lastName = default(string), double latitude = default(double), string line1 = default(string), string line2 = default(string), double longitude = default(double), string notes = default(string), string phoneExtension = default(string), string phoneNumber = default(string), string postalCode = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), string regionCode = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddOrUpdateCustomerAddressRequest {\n");
        ...
        {
            return this.Equals(input as AddOrUpdateCustomerAddressRequest);
        }

        /// <summary>
        /// Returns true if AddOrUpdateCustomerAddressRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddOrUpdateCustomerAddressRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddOrUpdateCustomerAddressRequest input)
        {
            if (input == null)
                return false;
