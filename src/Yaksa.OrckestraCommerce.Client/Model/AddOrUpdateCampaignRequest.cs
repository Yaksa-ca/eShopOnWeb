...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddOrUpdateCampaignRequest")]
    public partial class AddOrUpdateCampaignRequest : IEquatable<AddOrUpdateCampaignRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddOrUpdateCampaignRequest" /> class.
        /// </summary>
        ...
        public AddOrUpdateCampaignRequest(bool allowOptOut = default(bool), string description = default(string), DateTime endDate = default(DateTime), string name = default(string), int priority = default(int), List<Promotion> promotions = default(List<Promotion>), DateTime startDate = default(DateTime), StatusEnum? status = default(StatusEnum?), string timeZone = default(string), string type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddOrUpdateCampaignRequest {\n");
        ...
        {
            return this.Equals(input as AddOrUpdateCampaignRequest);
        }

        /// <summary>
        /// Returns true if AddOrUpdateCampaignRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddOrUpdateCampaignRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddOrUpdateCampaignRequest input)
        {
            if (input == null)
                return false;
