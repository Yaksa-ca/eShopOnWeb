...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ShipmentFulfillmentInfoQueryResult")]
    public partial class ShipmentFulfillmentInfoQueryResult : IEquatable<ShipmentFulfillmentInfoQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentFulfillmentInfoQueryResult" /> class.
        /// </summary>
        ...
        public ShipmentFulfillmentInfoQueryResult(List<ShipmentFulfillmentInfo> results = default(List<ShipmentFulfillmentInfo>), int totalCount = default(int))
        {
        ...
        public List<ShipmentFulfillmentInfo> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentFulfillmentInfoQueryResult {\n");
        ...
        {
            return this.Equals(input as ShipmentFulfillmentInfoQueryResult);
        }

        /// <summary>
        /// Returns true if ShipmentFulfillmentInfoQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentFulfillmentInfoQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentFulfillmentInfoQueryResult input)
        {
            if (input == null)
                return false;
