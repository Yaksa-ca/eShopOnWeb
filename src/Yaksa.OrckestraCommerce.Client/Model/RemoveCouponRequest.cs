...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemoveCouponRequest")]
    public partial class RemoveCouponRequest : IEquatable<RemoveCouponRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveCouponRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemoveCouponRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveCouponRequest" /> class.
        /// </summary>
        ...
        /// <param name="couponCode">The unique identifier of the Coupon to be removed. (required).</param>
        public RemoveCouponRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string workflowToExecute = default(string), string couponCode = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for RemoveCouponRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for RemoveCouponRequest and cannot be null");
            // to ensure "couponCode" is required (not null)
            this.CouponCode = couponCode ?? throw new ArgumentNullException("couponCode is a required property for RemoveCouponRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The unique identifier of the Coupon to be removed.</value>
        [DataMember(Name = "couponCode", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoveCouponRequest {\n");
        ...
        {
            return this.Equals(input as RemoveCouponRequest);
        }

        /// <summary>
        /// Returns true if RemoveCouponRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveCouponRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveCouponRequest input)
        {
            if (input == null)
                return false;
