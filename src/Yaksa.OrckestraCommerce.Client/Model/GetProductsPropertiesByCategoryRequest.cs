...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetProductsPropertiesByCategoryRequest")]
    public partial class GetProductsPropertiesByCategoryRequest : IEquatable<GetProductsPropertiesByCategoryRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductsPropertiesByCategoryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetProductsPropertiesByCategoryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductsPropertiesByCategoryRequest" /> class.
        /// </summary>
        ...
        public GetProductsPropertiesByCategoryRequest(string scopeId = default(string), string cultureName = default(string), int maximumItems = default(int), List<string> propertiesNames = default(List<string>), SortByEnum? sortBy = default(SortByEnum?), SortDirectionEnum? sortDirection = default(SortDirectionEnum?), int startingIndex = default(int), string categoryId = default(string))
        {
            // to ensure "categoryId" is required (not null)
            this.CategoryId = categoryId ?? throw new ArgumentNullException("categoryId is a required property for GetProductsPropertiesByCategoryRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetProductsPropertiesByCategoryRequest {\n");
        ...
        {
            return this.Equals(input as GetProductsPropertiesByCategoryRequest);
        }

        /// <summary>
        /// Returns true if GetProductsPropertiesByCategoryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetProductsPropertiesByCategoryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetProductsPropertiesByCategoryRequest input)
        {
            if (input == null)
                return false;
