...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    public partial class CreateOrganizationRequest : IEquatable<CreateOrganizationRequest>, IValidatableObject
    {
        ...
        public CreateOrganizationRequest(List<string> addressIds = default(List<string>), DateTime created = default(DateTime), string createdBy = default(string), string description = default(string), string email = default(string), string faxExtension = default(string), string faxNumber = default(string), bool isActive = default(bool), DateTime lastModified = default(DateTime), string lastModifiedBy = default(string), string manager = default(string), string name = default(string), string organizationId = default(string), string phoneExtension = default(string), string phoneNumber = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), string tradingPartnerNumber = default(string))
        {
