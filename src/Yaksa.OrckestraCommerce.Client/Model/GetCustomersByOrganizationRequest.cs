...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCustomersByOrganizationRequest")]
    public partial class GetCustomersByOrganizationRequest : IEquatable<GetCustomersByOrganizationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomersByOrganizationRequest" /> class.
        /// </summary>
        /// <param name="scopeId">The id of the requested scope.</param>
        /// <param name="includeAddresses">Whether or not to fully load the collection of addresses linked to the customer..</param>
        ...
        public GetCustomersByOrganizationRequest(string scopeId = default(string), bool includeAddresses = default(bool), int maximumItems = default(int), string organizationId = default(string), int startingIndex = default(int))
        {
        ...
        /// </summary>
        /// <value>Whether or not to fully load the collection of addresses linked to the customer.</value>
        ...
        /// </summary>
        /// <value>The organization identifier of the customer to search for.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCustomersByOrganizationRequest {\n");
        ...
        {
            return this.Equals(input as GetCustomersByOrganizationRequest);
        }

        /// <summary>
        /// Returns true if GetCustomersByOrganizationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCustomersByOrganizationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCustomersByOrganizationRequest input)
        {
            if (input == null)
                return false;
