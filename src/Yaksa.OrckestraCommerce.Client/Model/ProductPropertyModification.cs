...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductPropertyModification")]
    public partial class ProductPropertyModification : IEquatable<ProductPropertyModification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductPropertyModification" /> class.
        /// </summary>
        ...
        public ProductPropertyModification(bool isLocalized = default(bool), DateTime lastModified = default(DateTime), Object currentValue = default(Object), Object oldValue = default(Object), string propertyName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductPropertyModification {\n");
        ...
        {
            return this.Equals(input as ProductPropertyModification);
        }

        /// <summary>
        /// Returns true if ProductPropertyModification instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductPropertyModification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductPropertyModification input)
        {
            if (input == null)
                return false;
