...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddLineItemInShipmentRequest")]
    public partial class AddLineItemInShipmentRequest : IEquatable<AddLineItemInShipmentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddLineItemInShipmentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddLineItemInShipmentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddLineItemInShipmentRequest" /> class.
        /// </summary>
        ...
        /// <param name="giftMessage">if the product is to be wrapped as a gift, a message to be written on the wrapping..</param>
        /// <param name="giftWrap">whether or not the item will be wrapped in a gift presentation..</param>
        /// <param name="lineItemId">The unique identifier of the LineItem to create..</param>
        /// <param name="placedPrice">The price of the line item, at the moment that the item is added to the cart..</param>
        /// <param name="productId">The unique identifier of the product. (required).</param>
        /// <param name="propertyBag">propertyBag.</param>
        /// <param name="quantity">The number of times this item is bought for this LineItem. (required).</param>
        ...
        /// <param name="variantId">The unique identifier of the product variant if it is one..</param>
        public AddLineItemInShipmentRequest(string cultureName = default(string), string workflowToExecute = default(string), string giftMessage = default(string), bool giftWrap = default(bool), string lineItemId = default(string), double placedPrice = default(double), string productId = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), double quantity = default(double), string recurringOrderFrequencyName = default(string), string recurringOrderProgramName = default(string), string variantId = default(string))
        {
            // to ensure "productId" is required (not null)
            this.ProductId = productId ?? throw new ArgumentNullException("productId is a required property for AddLineItemInShipmentRequest and cannot be null");
        ...
        /// </summary>
        /// <value>if the product is to be wrapped as a gift, a message to be written on the wrapping.</value>
        ...
        /// </summary>
        /// <value>whether or not the item will be wrapped in a gift presentation.</value>
        ...
        /// </summary>
        /// <value>The price of the line item, at the moment that the item is added to the cart.</value>
        ...
        /// </summary>
        /// <value>The unique identifier of the product variant if it is one.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddLineItemInShipmentRequest {\n");
        ...
        {
            return this.Equals(input as AddLineItemInShipmentRequest);
        }

        /// <summary>
        /// Returns true if AddLineItemInShipmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddLineItemInShipmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddLineItemInShipmentRequest input)
        {
            if (input == null)
                return false;
