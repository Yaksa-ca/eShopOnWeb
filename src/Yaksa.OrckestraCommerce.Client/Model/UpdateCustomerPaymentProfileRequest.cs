...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateCustomerPaymentProfileRequest")]
    public partial class UpdateCustomerPaymentProfileRequest : IEquatable<UpdateCustomerPaymentProfileRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCustomerPaymentProfileRequest" /> class.
        /// </summary>
        ...
        public UpdateCustomerPaymentProfileRequest(string externalIds = default(string), string id = default(string), string orderLocationId = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateCustomerPaymentProfileRequest {\n");
        ...
        {
            return this.Equals(input as UpdateCustomerPaymentProfileRequest);
        }

        /// <summary>
        /// Returns true if UpdateCustomerPaymentProfileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCustomerPaymentProfileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCustomerPaymentProfileRequest input)
        {
            if (input == null)
                return false;
