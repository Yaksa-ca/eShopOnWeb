...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RefreshPaymentRequest")]
    public partial class RefreshPaymentRequest : IEquatable<RefreshPaymentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefreshPaymentRequest" /> class.
        /// </summary>
        /// <param name="cultureName">The culture name in which language the data will be returned..</param>
        public RefreshPaymentRequest(string cultureName = default(string))
        {
        ...
        {
            return this.Equals(input as RefreshPaymentRequest);
        }

        /// <summary>
        /// Returns true if RefreshPaymentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RefreshPaymentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefreshPaymentRequest input)
        {
            if (input == null)
                return false;
