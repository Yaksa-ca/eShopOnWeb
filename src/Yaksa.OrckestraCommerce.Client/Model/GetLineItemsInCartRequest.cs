...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetLineItemsInCartRequest")]
    public partial class GetLineItemsInCartRequest : IEquatable<GetLineItemsInCartRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLineItemsInCartRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLineItemsInCartRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLineItemsInCartRequest" /> class.
        /// </summary>
        ...
        public GetLineItemsInCartRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for GetLineItemsInCartRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetLineItemsInCartRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLineItemsInCartRequest {\n");
        ...
        {
            return this.Equals(input as GetLineItemsInCartRequest);
        }

        /// <summary>
        /// Returns true if GetLineItemsInCartRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLineItemsInCartRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLineItemsInCartRequest input)
        {
            if (input == null)
                return false;
