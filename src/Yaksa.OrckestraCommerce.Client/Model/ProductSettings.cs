...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    public partial class ProductSettings : IEquatable<ProductSettings>, IValidatableObject
    {
        /// <summary>
        ...
        public enum DefaultProductImportStatusEnum
        {
            /// <summary>
            ...
            /// <summary>
            /// Enum SameAsGlobal for value: SameAsGlobal
            /// </summary>
            [EnumMember(Value = "SameAsGlobal")]
            SameAsGlobal = 3
        ...
        public SkuUniquenessLevelEnum? SkuUniquenessLevel { get; set; }
        /// <summary>
        ...
        /// <param name="maxNumberOfRelationships">the maximum number of relationships.</param>
        ...
        public ProductSettings(bool allowTranslationFromSalesToGlobal = default(bool), string availableInventoryStatuses = default(string), DefaultProductImportStatusEnum? defaultProductImportStatus = default(DefaultProductImportStatusEnum?), bool enableExtendedProductWorkflow = default(bool), bool isInventoryEnabled = default(bool), bool isPricingAuditEnabled = default(bool), int maxNumberOfMediaItems = default(int), int maxNumberOfProductAttributes = default(int), int maxNumberOfRelationships = default(int), int maxNumberOfVariantAttributes = default(int), int maxNumberOfVariants = default(int), int newProductDays = default(int), bool notifySameScopeOtherLanguages = default(bool), bool overrideGreaterThanZeroPricingConstraint = default(bool), int productExportMaxNumberOfItemPerFile = default(int), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), SkuUniquenessLevelEnum? skuUniquenessLevel = default(SkuUniquenessLevelEnum?))
        {
        ...
        /// </summary>
        /// <value>the maximum number of relationships</value>
        ...
        {
            return this.Equals(input as ProductSettings);
        }

        /// <summary>
        /// Returns true if ProductSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductSettings input)
        {
            if (input == null)
                return false;
