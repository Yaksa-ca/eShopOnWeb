...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemovePaymentRequest")]
    public partial class RemovePaymentRequest : IEquatable<RemovePaymentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemovePaymentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemovePaymentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemovePaymentRequest" /> class.
        /// </summary>
        ...
        /// <param name="id">The unique identifier of the Payment to be removed. (required).</param>
        public RemovePaymentRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string workflowToExecute = default(string), string id = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for RemovePaymentRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for RemovePaymentRequest and cannot be null");
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for RemovePaymentRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The unique identifier of the Payment to be removed.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemovePaymentRequest {\n");
        ...
        {
            return this.Equals(input as RemovePaymentRequest);
        }

        /// <summary>
        /// Returns true if RemovePaymentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RemovePaymentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemovePaymentRequest input)
        {
            if (input == null)
                return false;
