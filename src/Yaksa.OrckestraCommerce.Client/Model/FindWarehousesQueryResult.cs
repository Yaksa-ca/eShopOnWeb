...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FindWarehousesQueryResult")]
    public partial class FindWarehousesQueryResult : IEquatable<FindWarehousesQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FindWarehousesQueryResult" /> class.
        /// </summary>
        ...
        public FindWarehousesQueryResult(List<Warehouse> results = default(List<Warehouse>), int totalCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FindWarehousesQueryResult {\n");
        ...
        {
            return this.Equals(input as FindWarehousesQueryResult);
        }

        /// <summary>
        /// Returns true if FindWarehousesQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FindWarehousesQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FindWarehousesQueryResult input)
        {
            if (input == null)
                return false;
