...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FulfillmentSLAQueryResult")]
    public partial class FulfillmentSLAQueryResult : IEquatable<FulfillmentSLAQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillmentSLAQueryResult" /> class.
        /// </summary>
        ...
        public FulfillmentSLAQueryResult(List<FulfillmentSLA> results = default(List<FulfillmentSLA>), int totalCount = default(int))
        {
        ...
        public List<FulfillmentSLA> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FulfillmentSLAQueryResult {\n");
        ...
        {
            return this.Equals(input as FulfillmentSLAQueryResult);
        }

        /// <summary>
        /// Returns true if FulfillmentSLAQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FulfillmentSLAQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FulfillmentSLAQueryResult input)
        {
            if (input == null)
                return false;
