...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPaymentRequest")]
    public partial class GetPaymentRequest : IEquatable<GetPaymentRequest>, IValidatableObject
    {
        ...
        /// <param name="id">The unique identifier of the Payment to retreive (required).</param>
        public GetPaymentRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string id = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for GetPaymentRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetPaymentRequest and cannot be null");
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for GetPaymentRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The unique identifier of the Payment to retreive</value>
