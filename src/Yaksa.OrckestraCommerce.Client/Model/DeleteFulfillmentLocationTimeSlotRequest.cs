...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteFulfillmentLocationTimeSlotRequest")]
    public partial class DeleteFulfillmentLocationTimeSlotRequest : IEquatable<DeleteFulfillmentLocationTimeSlotRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteFulfillmentLocationTimeSlotRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteFulfillmentLocationTimeSlotRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteFulfillmentLocationTimeSlotRequest" /> class.
        /// </summary>
        ...
        public DeleteFulfillmentLocationTimeSlotRequest(string scopeId = default(string), string fulfillmentLocationId = default(string), FulfillmentMethodTypeEnum fulfillmentMethodType = default(FulfillmentMethodTypeEnum), string slotId = default(string))
        {
            // to ensure "fulfillmentLocationId" is required (not null)
            this.FulfillmentLocationId = fulfillmentLocationId ?? throw new ArgumentNullException("fulfillmentLocationId is a required property for DeleteFulfillmentLocationTimeSlotRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteFulfillmentLocationTimeSlotRequest {\n");
        ...
        {
            return this.Equals(input as DeleteFulfillmentLocationTimeSlotRequest);
        }

        /// <summary>
        /// Returns true if DeleteFulfillmentLocationTimeSlotRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteFulfillmentLocationTimeSlotRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteFulfillmentLocationTimeSlotRequest input)
        {
            if (input == null)
                return false;
