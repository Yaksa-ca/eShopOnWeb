...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemoveLineItemRequest")]
    public partial class RemoveLineItemRequest : IEquatable<RemoveLineItemRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveLineItemRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemoveLineItemRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveLineItemRequest" /> class.
        /// </summary>
        ...
        /// <param name="id">The unique identifier of the LineItem to be removed. (required).</param>
        public RemoveLineItemRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string workflowToExecute = default(string), string id = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for RemoveLineItemRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for RemoveLineItemRequest and cannot be null");
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for RemoveLineItemRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The unique identifier of the LineItem to be removed.</value>
        ...
        {
            return this.Equals(input as RemoveLineItemRequest);
        }

        /// <summary>
        /// Returns true if RemoveLineItemRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveLineItemRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveLineItemRequest input)
        {
            if (input == null)
                return false;
