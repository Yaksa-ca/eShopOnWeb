...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// ProcessedCart
    /// </summary>
    [DataContract(Name = "ProcessedCart")]
    public partial class ProcessedCart : IEquatable<ProcessedCart>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessedCart" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProcessedCart() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessedCart" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProcessedCart);
        }

        /// <summary>
        /// Returns true if ProcessedCart instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessedCart to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessedCart input)
        {
            if (input == null)
                return false;
