...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateShipmentRequest")]
    public partial class UpdateShipmentRequest : IEquatable<UpdateShipmentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="fulfillmentMethodCarrierName">The fulfillment method carrier name  for the fulfillment method..</param>
        /// <param name="fulfillmentMethodCarrierOptionDisplayName">fulfillmentMethodCarrierOptionDisplayName.</param>
        /// <param name="fulfillmentMethodCarrierServiceLevel">The fulfillment method carrier service level for this fulfillment method..</param>
        ...
        /// </summary>
        /// <value>The fulfillment method carrier name  for the fulfillment method.</value>
        ...
        /// </summary>
        /// <value>The fulfillment method carrier service level for this fulfillment method.</value>
        ...
        /// </summary>
        /// <value>Gets or sets the pick-up location identifier required when the selected shipping method type is ship to store; any value will be ignored otherwise.</value>
        ...
        {
            return this.Equals(input as UpdateShipmentRequest);
        }

        /// <summary>
        /// Returns true if UpdateShipmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateShipmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateShipmentRequest input)
        {
            if (input == null)
                return false;
