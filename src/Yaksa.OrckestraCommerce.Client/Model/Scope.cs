...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    public partial class Scope : IEquatable<Scope>, IValidatableObject
    {
        ...
        public Scope(List<Scope> children = default(List<Scope>), List<string> childrenIds = default(List<string>), Currency currency = default(Currency), string currencyIso = default(string), string defaultCulture = default(string), Dictionary<string, string> description = default(Dictionary<string, string>), DateTime endDate = default(DateTime), string id = default(string), bool isActive = default(bool), Dictionary<string, string> name = default(Dictionary<string, string>), string parentScopeId = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), int sequenceNumber = default(int), DateTime startDate = default(DateTime), TypeEnum? type = default(TypeEnum?))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Scope and cannot be null");
