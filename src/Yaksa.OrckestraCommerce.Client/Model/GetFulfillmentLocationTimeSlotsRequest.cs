...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetFulfillmentLocationTimeSlotsRequest")]
    public partial class GetFulfillmentLocationTimeSlotsRequest : IEquatable<GetFulfillmentLocationTimeSlotsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFulfillmentLocationTimeSlotsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetFulfillmentLocationTimeSlotsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFulfillmentLocationTimeSlotsRequest" /> class.
        /// </summary>
        ...
        public GetFulfillmentLocationTimeSlotsRequest(string scopeId = default(string), string fulfillmentLocationId = default(string), FulfillmentMethodTypeEnum fulfillmentMethodType = default(FulfillmentMethodTypeEnum))
        {
            // to ensure "fulfillmentLocationId" is required (not null)
            this.FulfillmentLocationId = fulfillmentLocationId ?? throw new ArgumentNullException("fulfillmentLocationId is a required property for GetFulfillmentLocationTimeSlotsRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetFulfillmentLocationTimeSlotsRequest {\n");
        ...
        {
            return this.Equals(input as GetFulfillmentLocationTimeSlotsRequest);
        }

        /// <summary>
        /// Returns true if GetFulfillmentLocationTimeSlotsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFulfillmentLocationTimeSlotsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFulfillmentLocationTimeSlotsRequest input)
        {
            if (input == null)
                return false;
