...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetInventorySchedulesRequest")]
    public partial class GetInventorySchedulesRequest : IEquatable<GetInventorySchedulesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInventorySchedulesRequest" /> class.
        /// </summary>
        /// <param name="scopeId">The id of the requested scope.</param>
        /// <param name="inventoryLocationId">the business id for the inventory location which schedules to retrieve.</param>
        public GetInventorySchedulesRequest(string scopeId = default(string), string inventoryLocationId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetInventorySchedulesRequest {\n");
        ...
        {
            return this.Equals(input as GetInventorySchedulesRequest);
        }

        /// <summary>
        /// Returns true if GetInventorySchedulesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetInventorySchedulesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetInventorySchedulesRequest input)
        {
            if (input == null)
                return false;
