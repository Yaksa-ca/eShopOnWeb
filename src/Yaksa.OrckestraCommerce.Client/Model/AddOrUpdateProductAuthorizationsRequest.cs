...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddOrUpdateProductAuthorizationsRequest")]
    public partial class AddOrUpdateProductAuthorizationsRequest : IEquatable<AddOrUpdateProductAuthorizationsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddOrUpdateProductAuthorizationsRequest" /> class.
        /// </summary>
        ...
        public AddOrUpdateProductAuthorizationsRequest(List<ProductIdAuthorization> productAuthorizations = default(List<ProductIdAuthorization>), bool includeProductDetails = default(bool), bool includeVariants = default(bool), string cultureName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddOrUpdateProductAuthorizationsRequest {\n");
        ...
        {
            return this.Equals(input as AddOrUpdateProductAuthorizationsRequest);
        }

        /// <summary>
        /// Returns true if AddOrUpdateProductAuthorizationsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddOrUpdateProductAuthorizationsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddOrUpdateProductAuthorizationsRequest input)
        {
            if (input == null)
                return false;
