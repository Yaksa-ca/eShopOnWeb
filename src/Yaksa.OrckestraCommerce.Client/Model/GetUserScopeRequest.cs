...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetUserScopeRequest")]
    public partial class GetUserScopeRequest : IEquatable<GetUserScopeRequest>, IValidatableObject
    {
        /// <summary>
        /// The module for which the scope will be define as default
        /// </summary>
        /// <value>The module for which the scope will be define as default</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserScopeRequest" /> class.
        /// </summary>
        /// <param name="module">The module for which the scope will be define as default.</param>
        public GetUserScopeRequest(ModuleEnum? module = default(ModuleEnum?))
        {
            this.Module = module;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetUserScopeRequest {\n");
        ...
        {
            return this.Equals(input as GetUserScopeRequest);
        }

        /// <summary>
        /// Returns true if GetUserScopeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserScopeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserScopeRequest input)
        {
            if (input == null)
                return false;
