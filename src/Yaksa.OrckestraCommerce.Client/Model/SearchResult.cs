...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    public partial class SearchResult : IEquatable<SearchResult>, IValidatableObject
    {
        ...
        public SearchResult(string correctedSearchTerms = default(string), List<Document> documents = default(List<Document>), List<Facet> facets = default(List<Facet>), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), int startIndex = default(int), List<Suggestion> suggestions = default(List<Suggestion>), long totalCount = default(long))
        {
