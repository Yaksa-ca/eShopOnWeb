...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateRelationshipsV2Request")]
    public partial class CreateRelationshipsV2Request : IEquatable<CreateRelationshipsV2Request>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRelationshipsV2Request" /> class.
        /// </summary>
        ...
        public CreateRelationshipsV2Request(int count = default(int), Dictionary<string, string> description = default(Dictionary<string, string>), List<RelationshipEntity> entities = default(List<RelationshipEntity>), EntitiesTypeEnum? entitiesType = default(EntitiesTypeEnum?), string merchandiseType = default(string), bool mutual = default(bool), string qualifier = default(string), List<RelationshipEntity> relatedEntities = default(List<RelationshipEntity>), RelatedEntitiesTypeEnum? relatedEntitiesType = default(RelatedEntitiesTypeEnum?))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateRelationshipsV2Request {\n");
        ...
        {
            return this.Equals(input as CreateRelationshipsV2Request);
        }

        /// <summary>
        /// Returns true if CreateRelationshipsV2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateRelationshipsV2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateRelationshipsV2Request input)
        {
            if (input == null)
                return false;
