...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddOrUpdateLineItemsInShipmentRequest")]
    public partial class AddOrUpdateLineItemsInShipmentRequest : IEquatable<AddOrUpdateLineItemsInShipmentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddOrUpdateLineItemsInShipmentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddOrUpdateLineItemsInShipmentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddOrUpdateLineItemsInShipmentRequest" /> class.
        /// </summary>
        ...
        public AddOrUpdateLineItemsInShipmentRequest(string cultureName = default(string), string workflowToExecute = default(string), List<LineItemInfo> lineItems = default(List<LineItemInfo>), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>))
        {
            // to ensure "lineItems" is required (not null)
            this.LineItems = lineItems ?? throw new ArgumentNullException("lineItems is a required property for AddOrUpdateLineItemsInShipmentRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddOrUpdateLineItemsInShipmentRequest {\n");
        ...
        {
            return this.Equals(input as AddOrUpdateLineItemsInShipmentRequest);
        }

        /// <summary>
        /// Returns true if AddOrUpdateLineItemsInShipmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddOrUpdateLineItemsInShipmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddOrUpdateLineItemsInShipmentRequest input)
        {
            if (input == null)
                return false;
