...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FulfillmentCarrierProviderInfo")]
    public partial class FulfillmentCarrierProviderInfo : IEquatable<FulfillmentCarrierProviderInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillmentCarrierProviderInfo" /> class.
        /// </summary>
        ...
        public FulfillmentCarrierProviderInfo(string description = default(string), Dictionary<string, string> displayName = default(Dictionary<string, string>), string id = default(string), string implementationTypeName = default(string), bool isActive = default(bool), string name = default(string), string scopeId = default(string), Dictionary<string, Object> values = default(Dictionary<string, Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FulfillmentCarrierProviderInfo {\n");
        ...
        {
            return this.Equals(input as FulfillmentCarrierProviderInfo);
        }

        /// <summary>
        /// Returns true if FulfillmentCarrierProviderInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of FulfillmentCarrierProviderInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FulfillmentCarrierProviderInfo input)
        {
            if (input == null)
                return false;
