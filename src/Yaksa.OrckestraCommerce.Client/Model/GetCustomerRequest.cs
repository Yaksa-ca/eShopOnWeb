...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCustomerRequest")]
    public partial class GetCustomerRequest : IEquatable<GetCustomerRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomerRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetCustomerRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomerRequest" /> class.
        /// </summary>
        /// <param name="scopeId">The id of the requested scope.</param>
        /// <param name="customerId">The unique id of the requested customer (required).</param>
        ...
        public GetCustomerRequest(string scopeId = default(string), string customerId = default(string), bool includeAddresses = default(bool))
        {
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetCustomerRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The unique id of the requested customer</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCustomerRequest {\n");
        ...
        {
            return this.Equals(input as GetCustomerRequest);
        }

        /// <summary>
        /// Returns true if GetCustomerRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCustomerRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCustomerRequest input)
        {
            if (input == null)
                return false;
