...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClearCartRequest")]
    public partial class ClearCartRequest : IEquatable<ClearCartRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClearCartRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClearCartRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClearCartRequest" /> class.
        /// </summary>
        ...
        public ClearCartRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for ClearCartRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for ClearCartRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClearCartRequest {\n");
        ...
        {
            return this.Equals(input as ClearCartRequest);
        }

        /// <summary>
        /// Returns true if ClearCartRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ClearCartRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClearCartRequest input)
        {
            if (input == null)
                return false;
