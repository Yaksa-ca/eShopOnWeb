...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// OrderQueryResult
    /// </summary>
    [DataContract(Name = "OrderQueryResult")]
    public partial class OrderQueryResult : IEquatable<OrderQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderQueryResult" /> class.
        /// </summary>
        ...
        public OrderQueryResult(List<OrderItem> results = default(List<OrderItem>), int totalCount = default(int))
        {
        ...
        public List<OrderItem> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderQueryResult {\n");
        ...
        {
            return this.Equals(input as OrderQueryResult);
        }

        /// <summary>
        /// Returns true if OrderQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderQueryResult input)
        {
            if (input == null)
                return false;
