...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateShipmentDocumentRequest")]
    public partial class UpdateShipmentDocumentRequest : IEquatable<UpdateShipmentDocumentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateShipmentDocumentRequest" /> class.
        /// </summary>
        ...
        public UpdateShipmentDocumentRequest(string additionalNotes = default(string), string contentType = default(string), string document = default(string), string documentType = default(string), double imageHeight = default(double), double imageWidth = default(double), string proofOfIdentity = default(string), string recipient = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateShipmentDocumentRequest {\n");
        ...
        {
            return this.Equals(input as UpdateShipmentDocumentRequest);
        }

        /// <summary>
        /// Returns true if UpdateShipmentDocumentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateShipmentDocumentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateShipmentDocumentRequest input)
        {
            if (input == null)
                return false;
