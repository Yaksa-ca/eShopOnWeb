...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetShipmentPickingMissionsRequest")]
    public partial class GetShipmentPickingMissionsRequest : IEquatable<GetShipmentPickingMissionsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetShipmentPickingMissionsRequest" /> class.
        /// </summary>
        ...
        public GetShipmentPickingMissionsRequest(string fulfillmentLocationId = default(string), string scopeId = default(string), string shipmentId = default(string), string status = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetShipmentPickingMissionsRequest {\n");
        ...
        {
            return this.Equals(input as GetShipmentPickingMissionsRequest);
        }

        /// <summary>
        /// Returns true if GetShipmentPickingMissionsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetShipmentPickingMissionsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetShipmentPickingMissionsRequest input)
        {
            if (input == null)
                return false;
