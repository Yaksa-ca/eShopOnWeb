...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetShipmentRequest")]
    public partial class GetShipmentRequest : IEquatable<GetShipmentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetShipmentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetShipmentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetShipmentRequest" /> class.
        /// </summary>
        ...
        /// <param name="id">The unique identifier of the Shipment to retreive (required).</param>
        public GetShipmentRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string id = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for GetShipmentRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetShipmentRequest and cannot be null");
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for GetShipmentRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The unique identifier of the Shipment to retreive</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetShipmentRequest {\n");
        ...
        {
            return this.Equals(input as GetShipmentRequest);
        }

        /// <summary>
        /// Returns true if GetShipmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetShipmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetShipmentRequest input)
        {
            if (input == null)
                return false;
