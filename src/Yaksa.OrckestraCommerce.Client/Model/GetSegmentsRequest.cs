...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSegmentsRequest")]
    public partial class GetSegmentsRequest : IEquatable<GetSegmentsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSegmentsRequest" /> class.
        /// </summary>
        ...
        public GetSegmentsRequest(int maximumItems = default(int), int startingIndex = default(int), bool validateTargeting = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSegmentsRequest {\n");
        ...
        {
            return this.Equals(input as GetSegmentsRequest);
        }

        /// <summary>
        /// Returns true if GetSegmentsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSegmentsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSegmentsRequest input)
        {
            if (input == null)
                return false;
