...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdatePriceListEntryRequest")]
    public partial class UpdatePriceListEntryRequest : IEquatable<UpdatePriceListEntryRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePriceListEntryRequest" /> class.
        /// </summary>
        ...
        /// <param name="price">The price of the updated price list entry.</param>
        /// <param name="priceListId">The id of the price list for which we want to update a price list entry.</param>
        /// <param name="variantId">The id of the variant for which we want to update a price list entry.</param>
        public UpdatePriceListEntryRequest(bool isIgnored = default(bool), double price = default(double), string priceListId = default(string), string variantId = default(string))
        {
        ...
        /// </summary>
        /// <value>The price of the updated price list entry</value>
        ...
        /// </summary>
        /// <value>The id of the price list for which we want to update a price list entry</value>
        ...
        /// </summary>
        /// <value>The id of the variant for which we want to update a price list entry</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePriceListEntryRequest {\n");
        ...
        {
            return this.Equals(input as UpdatePriceListEntryRequest);
        }

        /// <summary>
        /// Returns true if UpdatePriceListEntryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePriceListEntryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePriceListEntryRequest input)
        {
            if (input == null)
                return false;
