...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCartStatesRequest")]
    public partial class GetCartStatesRequest : IEquatable<GetCartStatesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCartStatesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetCartStatesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCartStatesRequest" /> class.
        /// </summary>
        ...
        public GetCartStatesRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for GetCartStatesRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetCartStatesRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCartStatesRequest {\n");
        ...
        {
            return this.Equals(input as GetCartStatesRequest);
        }

        /// <summary>
        /// Returns true if GetCartStatesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCartStatesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCartStatesRequest input)
        {
            if (input == null)
                return false;
