...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthorizePaymentRequest")]
    public partial class AuthorizePaymentRequest : IEquatable<AuthorizePaymentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public AuthorizePaymentRequest(string cultureName = default(string))
        {
        ...
        {
            return this.Equals(input as AuthorizePaymentRequest);
        }

        /// <summary>
        /// Returns true if AuthorizePaymentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorizePaymentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorizePaymentRequest input)
        {
            if (input == null)
                return false;
