...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FindProfileInstancesQueryResult")]
    public partial class FindProfileInstancesQueryResult : IEquatable<FindProfileInstancesQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FindProfileInstancesQueryResult" /> class.
        /// </summary>
        ...
        public FindProfileInstancesQueryResult(List<CustomProfile> results = default(List<CustomProfile>), int totalCount = default(int))
        {
        ...
        public List<CustomProfile> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FindProfileInstancesQueryResult {\n");
        ...
        {
            return this.Equals(input as FindProfileInstancesQueryResult);
        }

        /// <summary>
        /// Returns true if FindProfileInstancesQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FindProfileInstancesQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FindProfileInstancesQueryResult input)
        {
            if (input == null)
                return false;
