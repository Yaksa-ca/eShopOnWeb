...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FindOrganizationsQueryResult")]
    public partial class FindOrganizationsQueryResult : IEquatable<FindOrganizationsQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FindOrganizationsQueryResult" /> class.
        /// </summary>
        ...
        public FindOrganizationsQueryResult(List<Organization> results = default(List<Organization>), int totalCount = default(int))
        {
        ...
        public List<Organization> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FindOrganizationsQueryResult {\n");
        ...
        {
            return this.Equals(input as FindOrganizationsQueryResult);
        }

        /// <summary>
        /// Returns true if FindOrganizationsQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FindOrganizationsQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FindOrganizationsQueryResult input)
        {
            if (input == null)
                return false;
