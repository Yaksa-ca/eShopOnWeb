...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetProductDraftRequest")]
    public partial class GetProductDraftRequest : IEquatable<GetProductDraftRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductDraftRequest" /> class.
        /// </summary>
        ...
        public GetProductDraftRequest(string scopeId = default(string), string cultureName = default(string), string productId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetProductDraftRequest {\n");
        ...
        {
            return this.Equals(input as GetProductDraftRequest);
        }

        /// <summary>
        /// Returns true if GetProductDraftRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetProductDraftRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetProductDraftRequest input)
        {
            if (input == null)
                return false;
