...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetProductsByIdsV2Request")]
    public partial class GetProductsByIdsV2Request : IEquatable<GetProductsByIdsV2Request>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductsByIdsV2Request" /> class.
        /// </summary>
        ...
        public GetProductsByIdsV2Request(string cultureName = default(string), bool includeVariants = default(bool), bool includeMedia = default(bool), bool includePriceLists = default(bool), bool includeRelationships = default(bool), bool includeImageUrl = default(bool), List<string> productIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetProductsByIdsV2Request {\n");
        ...
        {
            return this.Equals(input as GetProductsByIdsV2Request);
        }

        /// <summary>
        /// Returns true if GetProductsByIdsV2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of GetProductsByIdsV2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetProductsByIdsV2Request input)
        {
            if (input == null)
                return false;
