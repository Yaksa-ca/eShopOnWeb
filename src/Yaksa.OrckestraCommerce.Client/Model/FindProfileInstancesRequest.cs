...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FindProfileInstancesRequest")]
    public partial class FindProfileInstancesRequest : IEquatable<FindProfileInstancesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FindProfileInstancesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FindProfileInstancesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FindProfileInstancesRequest" /> class.
        /// </summary>
        ...
        /// <param name="searchTerms">The phrases to search for in a text field containing all the information of the CustomProfile..</param>
        public FindProfileInstancesRequest(string configurationName = default(string), string cultureName = default(string), Query query = default(Query), string searchTerms = default(string))
        {
            // to ensure "cultureName" is required (not null)
            this.CultureName = cultureName ?? throw new ArgumentNullException("cultureName is a required property for FindProfileInstancesRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The phrases to search for in a text field containing all the information of the CustomProfile.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FindProfileInstancesRequest {\n");
        ...
        {
            return this.Equals(input as FindProfileInstancesRequest);
        }

        /// <summary>
        /// Returns true if FindProfileInstancesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FindProfileInstancesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FindProfileInstancesRequest input)
        {
            if (input == null)
                return false;
