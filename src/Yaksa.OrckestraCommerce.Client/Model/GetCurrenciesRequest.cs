...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCurrenciesRequest")]
    public partial class GetCurrenciesRequest : IEquatable<GetCurrenciesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrenciesRequest" /> class.
        /// </summary>
        /// <param name="cultureName">The culture name in which language the data will be returned.</param>
        /// <param name="includeUnsupported">Whether to include the unsupported currencies.</param>
        public GetCurrenciesRequest(string cultureName = default(string), bool includeUnsupported = default(bool))
        {
        ...
        /// </summary>
        /// <value>Whether to include the unsupported currencies</value>
        ...
        {
            return this.Equals(input as GetCurrenciesRequest);
        }

        /// <summary>
        /// Returns true if GetCurrenciesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCurrenciesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCurrenciesRequest input)
        {
            if (input == null)
                return false;
