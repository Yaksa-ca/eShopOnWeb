...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateWarehouseRequest")]
    public partial class UpdateWarehouseRequest : IEquatable<UpdateWarehouseRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWarehouseRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateWarehouseRequest);
        }

        /// <summary>
        /// Returns true if UpdateWarehouseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateWarehouseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateWarehouseRequest input)
        {
            if (input == null)
                return false;
