...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchAvailableProductsByCategoryResponse")]
    public partial class SearchAvailableProductsByCategoryResponse : IEquatable<SearchAvailableProductsByCategoryResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchAvailableProductsByCategoryResponse" /> class.
        /// </summary>
        ...
        public SearchAvailableProductsByCategoryResponse(string correctedSearchTerms = default(string), List<ProductDocument> documents = default(List<ProductDocument>), List<Facet> facets = default(List<Facet>), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), int startIndex = default(int), List<Suggestion> suggestions = default(List<Suggestion>), long totalCount = default(long), List<SelectedFacet> selectedFacets = default(List<SelectedFacet>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchAvailableProductsByCategoryResponse {\n");
        ...
        {
            return this.Equals(input as SearchAvailableProductsByCategoryResponse);
        }

        /// <summary>
        /// Returns true if SearchAvailableProductsByCategoryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchAvailableProductsByCategoryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchAvailableProductsByCategoryResponse input)
        {
            if (input == null)
                return false;
