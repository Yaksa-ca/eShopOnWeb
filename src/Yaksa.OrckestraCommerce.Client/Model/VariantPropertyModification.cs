...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VariantPropertyModification")]
    public partial class VariantPropertyModification : IEquatable<VariantPropertyModification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VariantPropertyModification" /> class.
        /// </summary>
        ...
        public VariantPropertyModification(bool isLocalized = default(bool), DateTime lastModified = default(DateTime), Object currentValue = default(Object), Object oldValue = default(Object), string propertyName = default(string), string variantId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VariantPropertyModification {\n");
        ...
        {
            return this.Equals(input as VariantPropertyModification);
        }

        /// <summary>
        /// Returns true if VariantPropertyModification instances are equal
        /// </summary>
        /// <param name="input">Instance of VariantPropertyModification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VariantPropertyModification input)
        {
            if (input == null)
                return false;
