...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetStoreByNameRequest")]
    public partial class GetStoreByNameRequest : IEquatable<GetStoreByNameRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetStoreByNameRequest" /> class.
        /// </summary>
        ...
        public GetStoreByNameRequest(string scopeId = default(string), string cultureName = default(string), bool includeAddresses = default(bool), bool includeOperatingStatus = default(bool), bool includeSchedules = default(bool), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetStoreByNameRequest {\n");
        ...
        {
            return this.Equals(input as GetStoreByNameRequest);
        }

        /// <summary>
        /// Returns true if GetStoreByNameRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetStoreByNameRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetStoreByNameRequest input)
        {
            if (input == null)
                return false;
