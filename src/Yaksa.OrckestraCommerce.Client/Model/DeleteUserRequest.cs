...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    public partial class DeleteUserRequest : IEquatable<DeleteUserRequest>, IValidatableObject
    {
        ...
        public DeleteUserRequest(string userName = default(string))
        {
            // to ensure "userName" is required (not null)
            this.UserName = userName ?? throw new ArgumentNullException("userName is a required property for DeleteUserRequest and cannot be null");
        }
