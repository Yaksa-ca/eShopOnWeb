...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchAvailableProductsRequest")]
    public partial class SearchAvailableProductsRequest : IEquatable<SearchAvailableProductsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchAvailableProductsRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchAvailableProductsRequest {\n");
        ...
        {
            return this.Equals(input as SearchAvailableProductsRequest);
        }

        /// <summary>
        /// Returns true if SearchAvailableProductsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchAvailableProductsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchAvailableProductsRequest input)
        {
            if (input == null)
                return false;
