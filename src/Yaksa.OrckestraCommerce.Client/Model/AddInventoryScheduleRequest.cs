...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddInventoryScheduleRequest")]
    public partial class AddInventoryScheduleRequest : IEquatable<AddInventoryScheduleRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddInventoryScheduleRequest" /> class.
        /// </summary>
        /// <param name="scopeId">The id of the requested scope.</param>
        /// <param name="dateRange">dateRange.</param>
        /// <param name="inventoryStatus">The status of product inventory.</param>
        /// <param name="scheduleId">The inventory schedule identifier.</param>
        /// <param name="sku">The associated product sku.</param>
        public AddInventoryScheduleRequest(string scopeId = default(string), DateRange dateRange = default(DateRange), InventoryStatusEnum? inventoryStatus = default(InventoryStatusEnum?), string scheduleId = default(string), string sku = default(string))
        {
        ...
        /// </summary>
        /// <value>The inventory schedule identifier</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddInventoryScheduleRequest {\n");
        ...
        {
            return this.Equals(input as AddInventoryScheduleRequest);
        }

        /// <summary>
        /// Returns true if AddInventoryScheduleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddInventoryScheduleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddInventoryScheduleRequest input)
        {
            if (input == null)
                return false;
