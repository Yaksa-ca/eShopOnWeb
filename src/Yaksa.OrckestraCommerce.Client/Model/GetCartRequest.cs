...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCartRequest")]
    public partial class GetCartRequest : IEquatable<GetCartRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCartRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetCartRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCartRequest" /> class.
        /// </summary>
        ...
        public GetCartRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string workflowToExecute = default(string), bool executeWorkflow = default(bool))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for GetCartRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetCartRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCartRequest {\n");
        ...
        {
            return this.Equals(input as GetCartRequest);
        }

        /// <summary>
        /// Returns true if GetCartRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCartRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCartRequest input)
        {
            if (input == null)
                return false;
