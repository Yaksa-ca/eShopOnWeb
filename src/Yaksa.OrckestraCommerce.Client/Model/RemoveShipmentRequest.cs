...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemoveShipmentRequest")]
    public partial class RemoveShipmentRequest : IEquatable<RemoveShipmentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveShipmentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemoveShipmentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveShipmentRequest" /> class.
        /// </summary>
        ...
        /// <param name="id">The unique identifier of the Shipment to be removed. (required).</param>
        public RemoveShipmentRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string workflowToExecute = default(string), string id = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for RemoveShipmentRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for RemoveShipmentRequest and cannot be null");
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for RemoveShipmentRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The unique identifier of the Shipment to be removed.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoveShipmentRequest {\n");
        ...
        {
            return this.Equals(input as RemoveShipmentRequest);
        }

        /// <summary>
        /// Returns true if RemoveShipmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveShipmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveShipmentRequest input)
        {
            if (input == null)
                return false;
