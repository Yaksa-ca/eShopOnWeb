...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ShipmentDocumentQueryResult")]
    public partial class ShipmentDocumentQueryResult : IEquatable<ShipmentDocumentQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentQueryResult" /> class.
        /// </summary>
        ...
        public ShipmentDocumentQueryResult(List<ShipmentDocument> results = default(List<ShipmentDocument>), int totalCount = default(int))
        {
        ...
        public List<ShipmentDocument> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDocumentQueryResult {\n");
        ...
        {
            return this.Equals(input as ShipmentDocumentQueryResult);
        }

        /// <summary>
        /// Returns true if ShipmentDocumentQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentDocumentQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentDocumentQueryResult input)
        {
            if (input == null)
                return false;
