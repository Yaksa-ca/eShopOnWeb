...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VoidPaymentRequest")]
    public partial class VoidPaymentRequest : IEquatable<VoidPaymentRequest>, IValidatableObject
    {
        ...
        public VoidPaymentRequest(string cultureName = default(string))
        {
        ...
        {
            return this.Equals(input as VoidPaymentRequest);
        }

        /// <summary>
        /// Returns true if VoidPaymentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of VoidPaymentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoidPaymentRequest input)
        {
            if (input == null)
                return false;
