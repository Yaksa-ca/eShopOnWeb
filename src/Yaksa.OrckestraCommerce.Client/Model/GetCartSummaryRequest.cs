...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCartSummaryRequest")]
    public partial class GetCartSummaryRequest : IEquatable<GetCartSummaryRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCartSummaryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetCartSummaryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCartSummaryRequest" /> class.
        /// </summary>
        ...
        public GetCartSummaryRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string workflowToExecute = default(string), bool executeWorkflow = default(bool))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for GetCartSummaryRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetCartSummaryRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCartSummaryRequest {\n");
        ...
        {
            return this.Equals(input as GetCartSummaryRequest);
        }

        /// <summary>
        /// Returns true if GetCartSummaryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCartSummaryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCartSummaryRequest input)
        {
            if (input == null)
                return false;
