...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ImportProductsRequest")]
    public partial class ImportProductsRequest : IEquatable<ImportProductsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportProductsRequest" /> class.
        /// </summary>
        ...
        public ImportProductsRequest(bool allowPricesDeleting = default(bool), string correlationId = default(string), int maximumErrors = default(int), string path = default(string), bool rebuildSearchIndex = default(bool), bool reIndex = default(bool), string taskId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportProductsRequest {\n");
        ...
        {
            return this.Equals(input as ImportProductsRequest);
        }

        /// <summary>
        /// Returns true if ImportProductsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportProductsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportProductsRequest input)
        {
            if (input == null)
                return false;
