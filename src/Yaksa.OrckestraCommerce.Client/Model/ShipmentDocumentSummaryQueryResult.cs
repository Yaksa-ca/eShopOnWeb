...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ShipmentDocumentSummaryQueryResult")]
    public partial class ShipmentDocumentSummaryQueryResult : IEquatable<ShipmentDocumentSummaryQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentSummaryQueryResult" /> class.
        /// </summary>
        ...
        public ShipmentDocumentSummaryQueryResult(List<ShipmentDocumentSummary> results = default(List<ShipmentDocumentSummary>), int totalCount = default(int))
        {
        ...
        public List<ShipmentDocumentSummary> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDocumentSummaryQueryResult {\n");
        ...
        {
            return this.Equals(input as ShipmentDocumentSummaryQueryResult);
        }

        /// <summary>
        /// Returns true if ShipmentDocumentSummaryQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentDocumentSummaryQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentDocumentSummaryQueryResult input)
        {
            if (input == null)
                return false;
