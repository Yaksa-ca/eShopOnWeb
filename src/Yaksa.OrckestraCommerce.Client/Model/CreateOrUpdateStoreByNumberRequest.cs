...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOrUpdateStoreByNumberRequest")]
    public partial class CreateOrUpdateStoreByNumberRequest : IEquatable<CreateOrUpdateStoreByNumberRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrUpdateStoreByNumberRequest" /> class.
        /// </summary>
        /// <param name="addresses">The store&#39;s addresses..</param>
        ...
        /// <param name="faxExtension">the extension for the fax number of the store..</param>
        ...
        /// <param name="isInventoryEnabled">value indicating whether this store has inventory enabled.</param>
        /// <param name="isPickUpLocation">a value indicating whether this store is a pickup location for order fulfillment..</param>
        ...
        /// <param name="supportPickUp">a value indicating whether this store supports pickup for order fulfillment..</param>
        ...
        public CreateOrUpdateStoreByNumberRequest(List<Address> addresses = default(List<Address>), FulfillmentSchedule deliverySchedule = default(FulfillmentSchedule), bool deliveryScheduleManaged = default(bool), Dictionary<string, string> description = default(Dictionary<string, string>), Dictionary<string, string> displayName = default(Dictionary<string, string>), string email = default(string), string faxExtension = default(string), string faxNumber = default(string), string inventoryLocationId = default(string), string inventoryProviderId = default(string), bool isActive = default(bool), bool isAtpEnabled = default(bool), bool isInventoryEnabled = default(bool), bool isPickUpLocation = default(bool), string manager = default(string), string name = default(string), OperatingStatus operatingStatus = default(OperatingStatus), string phoneExtension = default(string), string phoneNumber = default(string), FulfillmentSchedule pickUpSchedule = default(FulfillmentSchedule), bool pickUpScheduleManaged = default(bool), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), FulfillmentSchedule schedule = default(FulfillmentSchedule), StoreTypeEnum? storeType = default(StoreTypeEnum?), bool supportDelivery = default(bool), bool supportPickUp = default(bool), bool supportShipping = default(bool), bool supportShipToStore = default(bool), string timeZone = default(string))
        {
        ...
        /// </summary>
        /// <value>The store&#39;s addresses.</value>
        ...
        /// </summary>
        /// <value>the extension for the fax number of the store.</value>
        ...
        /// </summary>
        /// <value>value indicating whether this store has inventory enabled</value>
        [DataMember(Name = "isInventoryEnabled", EmitDefaultValue = true)]
        public bool IsInventoryEnabled { get; set; }

        /// <summary>
        /// a value indicating whether this store is a pickup location for order fulfillment.
        /// </summary>
        /// <value>a value indicating whether this store is a pickup location for order fulfillment.</value>
        ...
        /// <summary>
        /// a value indicating whether this store supports pickup for order fulfillment.
        /// </summary>
        /// <value>a value indicating whether this store supports pickup for order fulfillment.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateOrUpdateStoreByNumberRequest {\n");
        ...
        {
            return this.Equals(input as CreateOrUpdateStoreByNumberRequest);
        }

        /// <summary>
        /// Returns true if CreateOrUpdateStoreByNumberRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOrUpdateStoreByNumberRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOrUpdateStoreByNumberRequest input)
        {
            if (input == null)
                return false;
