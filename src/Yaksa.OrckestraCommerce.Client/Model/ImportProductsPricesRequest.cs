...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ImportProductsPricesRequest")]
    public partial class ImportProductsPricesRequest : IEquatable<ImportProductsPricesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportProductsPricesRequest" /> class.
        /// </summary>
        ...
        /// <param name="maximumErrors">The maximum number of validation errors that can be encountered..</param>
        ...
        public ImportProductsPricesRequest(bool allowPricesDeleting = default(bool), string correlationId = default(string), int maximumErrors = default(int), string path = default(string), bool rebuildSearchIndex = default(bool), string taskId = default(string))
        {
        ...
        /// </summary>
        /// <value>The maximum number of validation errors that can be encountered.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportProductsPricesRequest {\n");
        ...
        {
            return this.Equals(input as ImportProductsPricesRequest);
        }

        /// <summary>
        /// Returns true if ImportProductsPricesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportProductsPricesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportProductsPricesRequest input)
        {
            if (input == null)
                return false;
