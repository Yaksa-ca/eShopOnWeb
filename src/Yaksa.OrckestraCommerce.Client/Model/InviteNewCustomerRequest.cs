...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InviteNewCustomerRequest")]
    public partial class InviteNewCustomerRequest : IEquatable<InviteNewCustomerRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InviteNewCustomerRequest" /> class.
        /// </summary>
        ...
        public InviteNewCustomerRequest(string firstName = default(string), string lastName = default(string), string fileNumber = default(string), string emailAddress = default(string), string language = default(string), List<ProductIdAuthorization> productIdAuthorizations = default(List<ProductIdAuthorization>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InviteNewCustomerRequest {\n");
        ...
        {
            return this.Equals(input as InviteNewCustomerRequest);
        }

        /// <summary>
        /// Returns true if InviteNewCustomerRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InviteNewCustomerRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InviteNewCustomerRequest input)
        {
            if (input == null)
                return false;
