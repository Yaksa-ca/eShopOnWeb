...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetProductsPropertiesByDraftStateRequest")]
    public partial class GetProductsPropertiesByDraftStateRequest : IEquatable<GetProductsPropertiesByDraftStateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The draft state used to filter the products</value>
        [DataMember(Name = "draftState", IsRequired = true, EmitDefaultValue = false)]
        public DraftStateEnum DraftState { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductsPropertiesByDraftStateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetProductsPropertiesByDraftStateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductsPropertiesByDraftStateRequest" /> class.
        /// </summary>
        ...
        /// <param name="draftState">The draft state used to filter the products (required).</param>
        public GetProductsPropertiesByDraftStateRequest(string scopeId = default(string), string cultureName = default(string), int maximumItems = default(int), List<string> propertiesNames = default(List<string>), SortByEnum? sortBy = default(SortByEnum?), SortDirectionEnum? sortDirection = default(SortDirectionEnum?), int startingIndex = default(int), DraftStateEnum draftState = default(DraftStateEnum))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetProductsPropertiesByDraftStateRequest {\n");
        ...
        {
            return this.Equals(input as GetProductsPropertiesByDraftStateRequest);
        }

        /// <summary>
        /// Returns true if GetProductsPropertiesByDraftStateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetProductsPropertiesByDraftStateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetProductsPropertiesByDraftStateRequest input)
        {
            if (input == null)
                return false;
