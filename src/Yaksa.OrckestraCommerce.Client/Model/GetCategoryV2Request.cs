...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCategoryV2Request")]
    public partial class GetCategoryV2Request : IEquatable<GetCategoryV2Request>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCategoryV2Request" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetCategoryV2Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCategoryV2Request" /> class.
        /// </summary>
        ...
        /// <param name="includeChildren">Indicates if the relationships must be included in the response..</param>
        /// <param name="includeRelationships">Indicates if the relationships must be included in the response..</param>
        public GetCategoryV2Request(string scopeId = default(string), string categoryId = default(string), string cultureName = default(string), bool includeChildren = default(bool), bool includeRelationships = default(bool))
        {
            // to ensure "categoryId" is required (not null)
            this.CategoryId = categoryId ?? throw new ArgumentNullException("categoryId is a required property for GetCategoryV2Request and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCategoryV2Request {\n");
        ...
        {
            return this.Equals(input as GetCategoryV2Request);
        }

        /// <summary>
        /// Returns true if GetCategoryV2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCategoryV2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCategoryV2Request input)
        {
            if (input == null)
                return false;
