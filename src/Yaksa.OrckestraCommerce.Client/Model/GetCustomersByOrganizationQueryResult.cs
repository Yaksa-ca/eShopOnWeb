...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCustomersByOrganizationQueryResult")]
    public partial class GetCustomersByOrganizationQueryResult : IEquatable<GetCustomersByOrganizationQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomersByOrganizationQueryResult" /> class.
        /// </summary>
        ...
        public GetCustomersByOrganizationQueryResult(List<CustomerInfo> results = default(List<CustomerInfo>), int totalCount = default(int))
        {
        ...
        public List<CustomerInfo> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCustomersByOrganizationQueryResult {\n");
        ...
        {
            return this.Equals(input as GetCustomersByOrganizationQueryResult);
        }

        /// <summary>
        /// Returns true if GetCustomersByOrganizationQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCustomersByOrganizationQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCustomersByOrganizationQueryResult input)
        {
            if (input == null)
                return false;
