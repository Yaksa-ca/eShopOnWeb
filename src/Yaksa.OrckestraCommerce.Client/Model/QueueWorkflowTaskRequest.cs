...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueueWorkflowTaskRequest")]
    public partial class QueueWorkflowTaskRequest : IEquatable<QueueWorkflowTaskRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueWorkflowTaskRequest" /> class.
        /// </summary>
        ...
        /// <param name="workflowName">The relative path of the workflow xaml file..</param>
        public QueueWorkflowTaskRequest(string correlationId = default(string), Dictionary<string, Object> inputs = default(Dictionary<string, Object>), bool isSequential = default(bool), string sequenceGroup = default(string), int sequenceQuota = default(int), string taskName = default(string), string workflowName = default(string))
        {
        ...
        /// </summary>
        /// <value>The relative path of the workflow xaml file.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueWorkflowTaskRequest {\n");
        ...
        {
            return this.Equals(input as QueueWorkflowTaskRequest);
        }

        /// <summary>
        /// Returns true if QueueWorkflowTaskRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueWorkflowTaskRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueWorkflowTaskRequest input)
        {
            if (input == null)
                return false;
