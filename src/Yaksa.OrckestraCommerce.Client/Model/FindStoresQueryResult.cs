...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FindStoresQueryResult")]
    public partial class FindStoresQueryResult : IEquatable<FindStoresQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FindStoresQueryResult" /> class.
        /// </summary>
        ...
        public FindStoresQueryResult(List<Store> results = default(List<Store>), int totalCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FindStoresQueryResult {\n");
        ...
        {
            return this.Equals(input as FindStoresQueryResult);
        }

        /// <summary>
        /// Returns true if FindStoresQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FindStoresQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FindStoresQueryResult input)
        {
            if (input == null)
                return false;
