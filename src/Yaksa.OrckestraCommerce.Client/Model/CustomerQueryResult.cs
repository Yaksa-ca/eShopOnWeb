...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// CustomerQueryResult
    /// </summary>
    [DataContract(Name = "CustomerQueryResult")]
    public partial class CustomerQueryResult : IEquatable<CustomerQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerQueryResult" /> class.
        /// </summary>
        ...
        public CustomerQueryResult(List<Customer> results = default(List<Customer>), int totalCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomerQueryResult {\n");
        ...
        {
            return this.Equals(input as CustomerQueryResult);
        }

        /// <summary>
        /// Returns true if CustomerQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomerQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomerQueryResult input)
        {
            if (input == null)
                return false;
