...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// SegmentQueryResult
    /// </summary>
    [DataContract(Name = "SegmentQueryResult")]
    public partial class SegmentQueryResult : IEquatable<SegmentQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SegmentQueryResult" /> class.
        /// </summary>
        ...
        public SegmentQueryResult(List<Segment> results = default(List<Segment>), int totalCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SegmentQueryResult {\n");
        ...
        {
            return this.Equals(input as SegmentQueryResult);
        }

        /// <summary>
        /// Returns true if SegmentQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SegmentQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SegmentQueryResult input)
        {
            if (input == null)
                return false;
