...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteCategoryRequest")]
    public partial class DeleteCategoryRequest : IEquatable<DeleteCategoryRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public DeleteCategoryRequest(string scopeId = default(string), string categoryId = default(string), bool deleteProducts = default(bool))
        {
        ...
        {
            return this.Equals(input as DeleteCategoryRequest);
        }

        /// <summary>
        /// Returns true if DeleteCategoryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteCategoryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteCategoryRequest input)
        {
            if (input == null)
                return false;
