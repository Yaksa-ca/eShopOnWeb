...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// CustomProfile
    /// </summary>
    [DataContract(Name = "CustomProfile")]
    public partial class CustomProfile : IEquatable<CustomProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomProfile" /> class.
        /// </summary>
        ...
        public CustomProfile(string id = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), DateTime created = default(DateTime), string createdBy = default(string), DateTime lastModified = default(DateTime), string lastModifiedBy = default(string), string entityTypeName = default(string), bool isActive = default(bool), string name = default(string), int sequenceNumber = default(int))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for CustomProfile and cannot be null");
        ...
        {
            return this.Equals(input as CustomProfile);
        }

        /// <summary>
        /// Returns true if CustomProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomProfile input)
        {
            if (input == null)
                return false;
