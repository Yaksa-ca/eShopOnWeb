...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductInformationExportRequest")]
    public partial class ProductInformationExportRequest : IEquatable<ProductInformationExportRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductInformationExportRequest" /> class.
        /// </summary>
        ...
        /// <param name="fileFormat">The file format of the export, JSON, XML or Excel..</param>
        ...
        public ProductInformationExportRequest(bool breakInheritance = default(bool), string category = default(string), string correlationId = default(string), List<string> cultures = default(List<string>), string fileFormat = default(string), string filePath = default(string), bool includeCategories = default(bool), bool includePrices = default(bool), bool includeProducts = default(bool), bool includeSchema = default(bool), string taskId = default(string))
        {
        ...
        /// </summary>
        /// <value>The category to export.</value>
        ...
        /// </summary>
        /// <value>The file format of the export, JSON, XML or Excel.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductInformationExportRequest {\n");
        ...
        {
            return this.Equals(input as ProductInformationExportRequest);
        }

        /// <summary>
        /// Returns true if ProductInformationExportRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductInformationExportRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductInformationExportRequest input)
        {
            if (input == null)
                return false;
