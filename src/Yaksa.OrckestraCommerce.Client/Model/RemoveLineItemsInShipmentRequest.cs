...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemoveLineItemsInShipmentRequest")]
    public partial class RemoveLineItemsInShipmentRequest : IEquatable<RemoveLineItemsInShipmentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveLineItemsInShipmentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemoveLineItemsInShipmentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveLineItemsInShipmentRequest" /> class.
        /// </summary>
        ...
        public RemoveLineItemsInShipmentRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string workflowToExecute = default(string), string shipmentId = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for RemoveLineItemsInShipmentRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for RemoveLineItemsInShipmentRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The unique identifier of the Shipment to consider.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoveLineItemsInShipmentRequest {\n");
        ...
        {
            return this.Equals(input as RemoveLineItemsInShipmentRequest);
        }

        /// <summary>
        /// Returns true if RemoveLineItemsInShipmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveLineItemsInShipmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveLineItemsInShipmentRequest input)
        {
            if (input == null)
                return false;
