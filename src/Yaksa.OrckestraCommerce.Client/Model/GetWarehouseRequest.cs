...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetWarehouseRequest")]
    public partial class GetWarehouseRequest : IEquatable<GetWarehouseRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWarehouseRequest" /> class.
        /// </summary>
        ...
        /// <param name="includeAddresses">Specifies whether or not to load the collection of addresses linked to the warehouse..</param>
        /// <param name="includeOperatingStatus">Specifies whether or not to load the operating status of the warehouse..</param>
        /// <param name="includeSchedules">Specifies whether or not to load schedules of the warehouse..</param>
        public GetWarehouseRequest(string scopeId = default(string), string cultureName = default(string), string id = default(string), bool includeAddresses = default(bool), bool includeOperatingStatus = default(bool), bool includeSchedules = default(bool))
        {
        ...
        /// </summary>
        /// <value>The unique id of the warehouse.</value>
        ...
        /// </summary>
        /// <value>Specifies whether or not to load the collection of addresses linked to the warehouse.</value>
        ...
        /// </summary>
        /// <value>Specifies whether or not to load the operating status of the warehouse.</value>
        ...
        /// </summary>
        /// <value>Specifies whether or not to load schedules of the warehouse.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetWarehouseRequest {\n");
        ...
        {
            return this.Equals(input as GetWarehouseRequest);
        }

        /// <summary>
        /// Returns true if GetWarehouseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWarehouseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWarehouseRequest input)
        {
            if (input == null)
                return false;
