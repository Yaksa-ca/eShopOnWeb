...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetFulfillmentExceptionsRequest")]
    public partial class GetFulfillmentExceptionsRequest : IEquatable<GetFulfillmentExceptionsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFulfillmentExceptionsRequest" /> class.
        /// </summary>
        /// <param name="scopeId">The id of the requested scope.</param>
        /// <param name="fulfillmentLocationId">The fulfillment location identifier..</param>
        /// <param name="orderId">The order identifier..</param>
        public GetFulfillmentExceptionsRequest(string scopeId = default(string), string fulfillmentLocationId = default(string), string orderId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetFulfillmentExceptionsRequest {\n");
        ...
        {
            return this.Equals(input as GetFulfillmentExceptionsRequest);
        }

        /// <summary>
        /// Returns true if GetFulfillmentExceptionsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFulfillmentExceptionsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFulfillmentExceptionsRequest input)
        {
            if (input == null)
                return false;
