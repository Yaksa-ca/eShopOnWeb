...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FulfillmentOrderQueryResult")]
    public partial class FulfillmentOrderQueryResult : IEquatable<FulfillmentOrderQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillmentOrderQueryResult" /> class.
        /// </summary>
        ...
        public FulfillmentOrderQueryResult(List<FulfillmentOrder> results = default(List<FulfillmentOrder>), int totalCount = default(int))
        {
        ...
        public List<FulfillmentOrder> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FulfillmentOrderQueryResult {\n");
        ...
        {
            return this.Equals(input as FulfillmentOrderQueryResult);
        }

        /// <summary>
        /// Returns true if FulfillmentOrderQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FulfillmentOrderQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FulfillmentOrderQueryResult input)
        {
            if (input == null)
                return false;
