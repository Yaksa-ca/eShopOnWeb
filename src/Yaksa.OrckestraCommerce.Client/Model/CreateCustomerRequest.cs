...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    public partial class CreateCustomerRequest : IEquatable<CreateCustomerRequest>, IValidatableObject
    {
        ...
        /// <param name="addressIds">The customer&#39;s addresses..</param>
        ...
        /// <param name="lastModified">the date and time that the last modification was applied to the customer..</param>
        ...
        public CreateCustomerRequest(AccountStatusEnum? accountStatus = default(AccountStatusEnum?), List<string> addressIds = default(List<string>), string cellNumber = default(string), DateTime created = default(DateTime), string customerId = default(string), CustomerTypeEnum? customerType = default(CustomerTypeEnum?), string email = default(string), string faxExtension = default(string), string faxNumber = default(string), string firstName = default(string), string language = default(string), DateTime lastModified = default(DateTime), string lastName = default(string), string passwordQuestion = default(string), string phoneExtension = default(string), string phoneExtensionWork = default(string), string phoneNumber = default(string), string phoneNumberWork = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), string username = default(string))
        {
        ...
        /// </summary>
        /// <value>The customer&#39;s addresses.</value>
        ...
        /// </summary>
        /// <value>the date and time that the last modification was applied to the customer.</value>
