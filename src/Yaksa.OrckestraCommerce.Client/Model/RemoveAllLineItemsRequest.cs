...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemoveAllLineItemsRequest")]
    public partial class RemoveAllLineItemsRequest : IEquatable<RemoveAllLineItemsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAllLineItemsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemoveAllLineItemsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAllLineItemsRequest" /> class.
        /// </summary>
        ...
        public RemoveAllLineItemsRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string workflowToExecute = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for RemoveAllLineItemsRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for RemoveAllLineItemsRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoveAllLineItemsRequest {\n");
        ...
        {
            return this.Equals(input as RemoveAllLineItemsRequest);
        }

        /// <summary>
        /// Returns true if RemoveAllLineItemsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveAllLineItemsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveAllLineItemsRequest input)
        {
            if (input == null)
                return false;
