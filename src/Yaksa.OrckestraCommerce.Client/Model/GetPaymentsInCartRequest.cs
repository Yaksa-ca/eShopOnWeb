...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPaymentsInCartRequest")]
    public partial class GetPaymentsInCartRequest : IEquatable<GetPaymentsInCartRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPaymentsInCartRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPaymentsInCartRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPaymentsInCartRequest" /> class.
        /// </summary>
        ...
        public GetPaymentsInCartRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for GetPaymentsInCartRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetPaymentsInCartRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPaymentsInCartRequest {\n");
        ...
        {
            return this.Equals(input as GetPaymentsInCartRequest);
        }

        /// <summary>
        /// Returns true if GetPaymentsInCartRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPaymentsInCartRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPaymentsInCartRequest input)
        {
            if (input == null)
                return false;
