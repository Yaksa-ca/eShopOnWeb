...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateFulfillmentPackageTypeRequest")]
    public partial class CreateFulfillmentPackageTypeRequest : IEquatable<CreateFulfillmentPackageTypeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFulfillmentPackageTypeRequest" /> class.
        /// </summary>
        ...
        public CreateFulfillmentPackageTypeRequest(Dictionary<string, string> description = default(Dictionary<string, string>), Dictionary<string, string> displayName = default(Dictionary<string, string>), string distanceUOM = default(string), double height = default(double), string id = default(string), bool isActive = default(bool), double length = default(double), Dictionary<string, string> shortDisplayName = default(Dictionary<string, string>), double width = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateFulfillmentPackageTypeRequest {\n");
        ...
        {
            return this.Equals(input as CreateFulfillmentPackageTypeRequest);
        }

        /// <summary>
        /// Returns true if CreateFulfillmentPackageTypeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateFulfillmentPackageTypeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateFulfillmentPackageTypeRequest input)
        {
            if (input == null)
                return false;
