...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteProductsRequest")]
    public partial class DeleteProductsRequest : IEquatable<DeleteProductsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteProductsRequest" /> class.
        /// </summary>
        /// <param name="correlationId">The correlation id for the durable task..</param>
        /// <param name="filterByPublicationStatus">The publication status to filter the products by. The filtering isn&#39;t applied for explicitly passed Product Ids..</param>
        /// <param name="includeUncategorized">When set to true, will indicate that all of the uncategorized products should be deleted..</param>
        /// <param name="parentCategoryIds">The categories id values of the categories from which products will be deleted..</param>
        /// <param name="productIds">The id values of the products to be deleted..</param>
        public DeleteProductsRequest(string correlationId = default(string), string filterByPublicationStatus = default(string), bool includeUncategorized = default(bool), List<string> parentCategoryIds = default(List<string>), List<string> productIds = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>The publication status to filter the products by. The filtering isn&#39;t applied for explicitly passed Product Ids.</value>
        ...
        /// </summary>
        /// <value>When set to true, will indicate that all of the uncategorized products should be deleted.</value>
        ...
        /// </summary>
        /// <value>The categories id values of the categories from which products will be deleted.</value>
        ...
        /// </summary>
        /// <value>The id values of the products to be deleted.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteProductsRequest {\n");
        ...
        {
            return this.Equals(input as DeleteProductsRequest);
        }

        /// <summary>
        /// Returns true if DeleteProductsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteProductsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteProductsRequest input)
        {
            if (input == null)
                return false;
