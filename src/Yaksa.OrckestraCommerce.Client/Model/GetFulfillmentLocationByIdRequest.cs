...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetFulfillmentLocationByIdRequest")]
    public partial class GetFulfillmentLocationByIdRequest : IEquatable<GetFulfillmentLocationByIdRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFulfillmentLocationByIdRequest" /> class.
        /// </summary>
        /// <param name="scopeId">The id of the requested scope.</param>
        /// <param name="fulfillmentLocationId">the unique identifier of the Fulfillment location..</param>
        public GetFulfillmentLocationByIdRequest(string scopeId = default(string), string fulfillmentLocationId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetFulfillmentLocationByIdRequest {\n");
        ...
        {
            return this.Equals(input as GetFulfillmentLocationByIdRequest);
        }

        /// <summary>
        /// Returns true if GetFulfillmentLocationByIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFulfillmentLocationByIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFulfillmentLocationByIdRequest input)
        {
            if (input == null)
                return false;
