...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductInformationImportRequest")]
    public partial class ProductInformationImportRequest : IEquatable<ProductInformationImportRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductInformationImportRequest" /> class.
        /// </summary>
        ...
        public ProductInformationImportRequest(bool allowPricesDeleting = default(bool), string containerName = default(string), string correlationId = default(string), ImportProductExtendedOptions extendedOptions = default(ImportProductExtendedOptions), string fileFormat = default(string), int maximumErrors = default(int), string path = default(string), bool rebuildSearchIndex = default(bool), bool reIndex = default(bool), string taskId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductInformationImportRequest {\n");
        ...
        {
            return this.Equals(input as ProductInformationImportRequest);
        }

        /// <summary>
        /// Returns true if ProductInformationImportRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductInformationImportRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductInformationImportRequest input)
        {
            if (input == null)
                return false;
