...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetFulfillmentCompetitionRequest")]
    public partial class GetFulfillmentCompetitionRequest : IEquatable<GetFulfillmentCompetitionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFulfillmentCompetitionRequest" /> class.
        /// </summary>
        /// <param name="scopeId">The id of the requested scope.</param>
        /// <param name="fulfillmentCompetitionId">The fulfillment competition identifier..</param>
        public GetFulfillmentCompetitionRequest(string scopeId = default(string), string fulfillmentCompetitionId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetFulfillmentCompetitionRequest {\n");
        ...
        {
            return this.Equals(input as GetFulfillmentCompetitionRequest);
        }

        /// <summary>
        /// Returns true if GetFulfillmentCompetitionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFulfillmentCompetitionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFulfillmentCompetitionRequest input)
        {
            if (input == null)
                return false;
