...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetLineItemRequest")]
    public partial class GetLineItemRequest : IEquatable<GetLineItemRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLineItemRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLineItemRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLineItemRequest" /> class.
        /// </summary>
        ...
        /// <param name="id">The unique identifier of the LineItem to retreive (required).</param>
        public GetLineItemRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string id = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for GetLineItemRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetLineItemRequest and cannot be null");
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for GetLineItemRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The unique identifier of the LineItem to retreive</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLineItemRequest {\n");
        ...
        {
            return this.Equals(input as GetLineItemRequest);
        }

        /// <summary>
        /// Returns true if GetLineItemRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLineItemRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLineItemRequest input)
        {
            if (input == null)
                return false;
