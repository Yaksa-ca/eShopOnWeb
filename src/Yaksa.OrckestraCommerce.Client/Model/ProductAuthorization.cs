...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductAuthorization")]
    public partial class ProductAuthorization : IEquatable<ProductAuthorization>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductAuthorization" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductAuthorization {\n");
        ...
        {
            return this.Equals(input as ProductAuthorization);
        }

        /// <summary>
        /// Returns true if ProductAuthorization instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductAuthorization to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductAuthorization input)
        {
            if (input == null)
                return false;
