...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddCouponRequest")]
    public partial class AddCouponRequest : IEquatable<AddCouponRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddCouponRequest" /> class.
        /// </summary>
        ...
        public AddCouponRequest(string cultureName = default(string), string workflowToExecute = default(string))
        {
        ...
        {
            return this.Equals(input as AddCouponRequest);
        }

        /// <summary>
        /// Returns true if AddCouponRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddCouponRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddCouponRequest input)
        {
            if (input == null)
                return false;
