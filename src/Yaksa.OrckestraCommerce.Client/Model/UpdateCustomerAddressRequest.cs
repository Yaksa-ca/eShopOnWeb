...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateCustomerAddressRequest")]
    public partial class UpdateCustomerAddressRequest : IEquatable<UpdateCustomerAddressRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCustomerAddressRequest" /> class.
        /// </summary>
        ...
        public UpdateCustomerAddressRequest(string addressName = default(string), string city = default(string), string countryCode = default(string), string email = default(string), string firstName = default(string), bool isPreferredBilling = default(bool), bool isPreferredShipping = default(bool), string lastName = default(string), double latitude = default(double), string line1 = default(string), string line2 = default(string), double longitude = default(double), string notes = default(string), string phoneExtension = default(string), string phoneNumber = default(string), string postalCode = default(string), Dictionary<string, Object> propertyBag = default(Dictionary<string, Object>), string regionCode = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateCustomerAddressRequest);
        }

        /// <summary>
        /// Returns true if UpdateCustomerAddressRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCustomerAddressRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCustomerAddressRequest input)
        {
            if (input == null)
                return false;
