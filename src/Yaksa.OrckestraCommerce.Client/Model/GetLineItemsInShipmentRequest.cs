...
namespace Yaksa.OrckestraCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetLineItemsInShipmentRequest")]
    public partial class GetLineItemsInShipmentRequest : IEquatable<GetLineItemsInShipmentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLineItemsInShipmentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLineItemsInShipmentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLineItemsInShipmentRequest" /> class.
        /// </summary>
        ...
        public GetLineItemsInShipmentRequest(string scopeId = default(string), string cartName = default(string), string cultureName = default(string), string customerId = default(string), string shipmentId = default(string))
        {
            // to ensure "cartName" is required (not null)
            this.CartName = cartName ?? throw new ArgumentNullException("cartName is a required property for GetLineItemsInShipmentRequest and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for GetLineItemsInShipmentRequest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLineItemsInShipmentRequest {\n");
        ...
        {
            return this.Equals(input as GetLineItemsInShipmentRequest);
        }

        /// <summary>
        /// Returns true if GetLineItemsInShipmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLineItemsInShipmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLineItemsInShipmentRequest input)
        {
            if (input == null)
                return false;
